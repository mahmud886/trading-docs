...
<Callout type="info" title="Level 1 vs Level 2">
  **Level 1** = Best bid/ask price only. **Level 2** = Full order book depth showing ALL pending orders at every price
  level. Professional traders need Level 2 for edge.
</Callout>
...
<Callout type="warning" title="Spoofing is Illegal">
  Spoofing is illegal in regulated markets (fined by SEC/CFTC). However, it still occurs in crypto and less regulated
  venues. Learn to identify it to avoid being trapped.
</Callout>
