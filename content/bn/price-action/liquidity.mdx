...
<Callout type="info" title="Smart Money-র রহস্য">
  Institution-দের বড় Position-এ Entry ও Exit করতে Liquidity প্রয়োজন। তারা সহজে Market-এ ৫০০ Lot কিনতে পারে না — তাদের
  কারো কাছ থেকে কেনা দরকার। Retail Trader-দের Stop Loss সেই Liquidity সরবরাহ করে। এজন্যই Price প্রায়ই সুস্পষ্ট Level
  "Hunt" করে তারপর Move করে।
</Callout>
