...
<Callout type="info" title="S/R হলো Zone, Line নয়">
  Professional Trader S/R-কে সুনির্দিষ্ট Line নয়, Zone হিসেবে দেখেন। Price সবসময় ঠিক একটি Price-এ React করে না — এটি
  একটি Area-তে React করে। ১০-৩০ Pip-এর Zone ভাবুন।
</Callout>
