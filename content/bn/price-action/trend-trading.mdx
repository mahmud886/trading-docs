...
<Callout type="info" title="সবচেয়ে লাভজনক পদ্ধতি">
  ৭০% এর বেশি লাভজনক Trade আসে Trend-following থেকে। Trend-এর বিরুদ্ধে লড়াই Retail Trader-দের হারার #১ কারণ। Trend শুধু
  আপনার বন্ধু নয় — এটি আপনার সম্পূর্ণ Edge।
</Callout>
