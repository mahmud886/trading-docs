...
<Callout type="warning" title="Context-ই সবকিছু">
  কোনো নির্দিষ্ট জায়গা ছাড়া Hammer অর্থহীন। এটি অবশ্যই একটি তাৎপর্যপূর্ণ Support Level, Order Block বা স্পষ্ট
  Downtrend-এর পরে তৈরি হতে হবে Valid হতে। অবস্থান Probability নির্ধারণ করে।
</Callout>
