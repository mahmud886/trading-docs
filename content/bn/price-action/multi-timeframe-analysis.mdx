...
<Callout type="info" title="Top-Down পদ্ধতি">
  Professional Trader কখনো একটি Timeframe থেকে Trade করেন না। তারা সবসময় Direction-এর জন্য সর্বোচ্চ প্রাসঙ্গিক
  Timeframe থেকে শুরু করেন, তারপর Entry-র জন্য নিচে নামেন। এই একটি অভ্যাসই Profitable Trader-কে Struggling Trader থেকে
  আলাদা করে।
</Callout>
