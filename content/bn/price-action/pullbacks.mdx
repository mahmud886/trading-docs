...
<Callout type="info" title="Buy the Dip, Sell the Rally">
  "Buy the dip" বলতে মূলত Pullback Trading বোঝায়। Impulsive Move-এর পর Price Chase করার বদলে, আপনি Key Level-এ Retrace
  করার অপেক্ষা করেন এবং Discount-এ Enter করেন। এটি Tighter Stop Loss ও ভালো Risk-to-Reward Ratio দেয়।
</Callout>
