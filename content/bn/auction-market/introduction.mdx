...
description: "অকশন মার্কেট থিওরি (AMT) বুঝুন — যে ফ্রেমওয়ার্ক ব্যাখ্যা করে প্রাইস কিভাবে ও কেন মুভ করে। মার্কেট কিভাবে প্রাইস ডিসকভারির মাধ্যমে বায়ার ও সেলারের মধ্যে ট্রেড সহজতর করে শিখুন।"
level: beginner
order: 1
