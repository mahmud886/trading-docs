...
<Callout type="info" title="মূল সত্য">
  Support ও Resistance সুনির্দিষ্ট Line নয় — এগুলো ZONE। React করার আগে Price প্রায়ই কয়েক Pip Overshoot বা Undershoot
  করে। সুনির্দিষ্ট Price নয়, Area হিসেবে চিন্তা করুন।
</Callout>
