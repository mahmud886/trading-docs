...
<Callout type="info" title="মূল বৈশিষ্ট্য">
  Perpetual Futures হলো Crypto Market-এ সবচেয়ে জনপ্রিয় Trading Instrument। এগুলো Futures-এর Leverage-কে Contract
  Expiry বা Rolling Position নিয়ে চিন্তা না করার সরলতার সাথে একত্রিত করে।
</Callout>
...
<Callout type="warning" title="নিরাপত্তা সুপারিশ">
  শেখার সময় সবসময় **Isolated Margin** ব্যবহার করুন। Cross Margin মানে একটি খারাপ Trade আপনার সম্পূর্ণ Account
  Liquidate করতে পারে। Isolated Margin আপনার সর্বোচ্চ Loss সেই নির্দিষ্ট Position-এ বরাদ্দকৃত Margin-এ সীমাবদ্ধ রাখে।
</Callout>
