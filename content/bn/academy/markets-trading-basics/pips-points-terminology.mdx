...
<Callout type="info" title="Terminology কেন গুরুত্বপূর্ণ">
  প্রতিটি Trading আলোচনা, Analysis এবং Strategy-তে স্ট্যান্ডার্ড Terminology ব্যবহৃত হয়। একটি মাত্র Term ভুল বুঝলে ভুল
  Position Sizing, ভুল Risk গণনা, বা সুযোগ হাতছাড়া হতে পারে।
</Callout>
...
<Callout type="warning" title="গুরুত্বপূর্ণ">
  Pip Value Pair ও Exchange Rate অনুযায়ী পরিবর্তিত হয়। যেসব Pair-এ USD Quote Currency (EUR/USD, GBP/USD), সেখানে Pip
  Value সবসময় Standard Lot-এ $10। অন্যান্য Pair-এ এটি ওঠানামা করে।
</Callout>
