...
description: "ক্রিপ্টো ট্রেডিংয়ে লিকুইডেশন অ্যানালাইসিস মাস্টার করুন। লিকুইডেশন হিটম্যাপ পড়া, ক্যাসকেড ইভেন্ট প্রেডিক্ট করা এবং লিকুইডেশন-ড্রিভেন মুভের জন্য পজিশন করা শিখুন।"
level: intermediate
order: 71
lastUpdated: "2026-06-10"
---

## Liquidation Heatmaps & Cascades
