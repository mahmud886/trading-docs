...
<Callout type="info" title="মূল সুবিধা">
  Options অন্য কোনো Instrument-এ পাওয়া যায় না এমন অনন্য সুবিধা দেয়: সংজ্ঞায়িত Maximum Risk, Leveraged Exposure, Time
  Decay থেকে Profit করার ক্ষমতা, এবং যেকোনো Market Direction-এ (Up, Down বা Sideways) Profit করার Strategy।
</Callout>
