...
<Callout type="info" title="Adding to Winners">
  Re-accumulation is how institutions scale into winning positions. They pause the markup, build more longs at a higher
  level, then push to the next target. This creates the "staircase" pattern in strong trends.
</Callout>
