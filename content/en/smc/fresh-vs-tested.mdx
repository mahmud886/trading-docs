...
description: "Learn to distinguish between fresh (untested) and tested supply/demand zones. Understand why fresh zones have higher probability and how to grade zone quality."
level: intermediate
order: 31
