...
<Callout type="info" title="Institutional Pricing Logic">
  Banks and institutions always seek the best possible price. They buy in discount zones and sell in premium zones. By
  identifying these zones, you trade alongside institutional order flow.
</Callout>
...
<Callout type="warning" title="Critical Rule">
  **Never buy in premium. Never sell in discount.** This single rule eliminates most bad trades. If an Order Block is in
  premium and you're bullish, skip it — wait for a discount OB.
</Callout>
