...
<Callout type="info" title="The Liquidity Concept">
  Think of liquidity as "fuel" for price movement. Price moves FROM liquidity that's been taken TO the next pool of
  liquidity. Understanding this flow is the foundation of Smart Money trading.
</Callout>
...
<Callout type="tip" title="The Flow Rule">
  **Price moves from internal liquidity to external liquidity, and from external liquidity to internal liquidity.** This
  alternating flow is one of the most powerful concepts in SMC.
</Callout>
