...
description: "Build a zone strength scoring system. Learn to evaluate supply/demand zones using departure speed, time at level, freshness, and volume criteria."
level: advanced
order: 33
