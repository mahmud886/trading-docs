...
description: "Learn rigorous backtesting methodology. Avoid survivorship bias, look-ahead bias, overfitting, and understand statistical significance testing for trading strategies."
level: intermediate
order: 6
