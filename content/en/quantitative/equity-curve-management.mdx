...
description: "Learn to manage your strategy based on equity curve behavior. Understand when to increase/decrease size, when to pause, and equity curve trading rules."
level: advanced
order: 8
