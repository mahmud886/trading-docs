...
<Callout type="info" title="The Betrayal Move">
  Just as Judas betrayed with a kiss (appearing friendly), the Judas Swing appears to be a genuine breakout but is
  actually a trap. The initial direction is a lie — the true move comes after.
</Callout>
