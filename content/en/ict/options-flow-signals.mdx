...
description: "Learn how hedge funds use options flow data for directional trading. Understand how large options trades reveal institutional positioning and expected moves."
level: advanced
order: 30
