...
description: "Master Gamma Exposure analysis. Learn how dealer hedging creates support/resistance levels, and how gamma flips from positive to negative regime."
level: expert
order: 32
