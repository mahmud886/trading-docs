...
description: "Master max pain theory — the price at which most options expire worthless. Learn how market makers hedge gamma exposure and why price gravitates toward max pain."
level: advanced
order: 31
