...
description: "Master single print analysis — areas where price moved so fast that only one TPO printed. Learn why single prints act as support/resistance and future targets."
level: advanced
order: 6
