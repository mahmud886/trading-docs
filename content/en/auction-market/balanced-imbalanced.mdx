...
description: "Distinguish between balanced markets (range-bound, mean-reverting) and imbalanced markets (trending, directional). Learn the optimal strategy for each market state."
level: advanced
order: 7
