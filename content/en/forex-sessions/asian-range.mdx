...
<Callout type="info" title="Why Asian Range Matters">
  The Asian Range creates liquidity pools on both sides. Buy stops accumulate above the Asian high, sell stops below the
  Asian low. London's algorithm targets this liquidity approximately 75% of trading days.
</Callout>
