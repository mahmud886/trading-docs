...
<Callout type="warning" title="The Trap">
  The first move at London Open is often FALSE. Smart money pushes price one direction to trigger stops and collect
  liquidity, then reverses to the true direction. Wait 30-60 minutes before entering.
</Callout>
