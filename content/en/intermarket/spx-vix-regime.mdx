...
description: "Master the SPX-VIX inverse correlation and regime detection. Learn how volatility regimes determine institutional behavior and optimal trading strategies."
level: advanced
order: 7
