...
<Callout type="tip" title="The Demo Challenge">
  If you can't make money on demo consistently, you won't make money with real money. Demo removes the emotional
  pressure so you can focus on skill development. Use it!
</Callout>
