...
<Callout type="info" title="The Math of Survival">
  If you risk 1% per trade, even 20 consecutive losses only costs you 18% of your account. You can recover. If you risk
  10% per trade, just 7 consecutive losses wipes out 50% of your account. Recovery becomes nearly impossible.
</Callout>
...
<Callout type="warning" title="Adjust for Gold and Indices">
  Gold (XAU/USD) and indices (NAS100) have different pip values. Gold: ~$1 per pip per 0.01 lot. NAS100: varies by
  broker. Always calculate based on YOUR broker's contract specifications.
</Callout>
