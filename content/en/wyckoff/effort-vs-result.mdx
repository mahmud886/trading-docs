...
description: "Understand the Effort vs Result principle — when volume (effort) doesn't match price movement (result), institutions are operating. Learn to identify divergences."
level: advanced
order: 7
