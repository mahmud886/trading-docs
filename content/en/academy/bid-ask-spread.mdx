...
<Callout type="info" title="Why This Matters">
  The spread is an invisible cost that many beginners ignore. On every trade you enter, you start at a LOSS equal to the
  spread. You must overcome this cost before reaching profit.
</Callout>
...
<Callout type="warning" title="Scalpers Beware">
  If your average profit target is 10 pips and the spread is 2 pips, you're paying 20% of your profit to the broker on
  every trade. Over hundreds of trades, this compounds significantly.
</Callout>
...
<Callout type="warning" title="Hidden Cost">
  A day trader making 5 trades daily on 1 standard lot can pay over $15,000/year just in spreads. This is why choosing a
  low-spread broker and timing your entries during tight-spread sessions is crucial.
</Callout>
