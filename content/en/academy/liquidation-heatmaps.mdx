...
description: "Master liquidation analysis for crypto trading. Learn to read liquidation heatmaps, predict cascade events, and position for liquidation-driven moves."
level: intermediate
order: 71
