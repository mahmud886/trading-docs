...
<Callout type="info" title="Pattern Trading Truth">
  Patterns don't predict the future with certainty. They provide probabilistic edges — situations where price is more
  LIKELY to move in a certain direction. Always combine with risk management.
</Callout>
...
<Callout type="warning" title="Important">
  Patterns FAIL frequently (30-40% of the time). This is why stop losses are non-negotiable. A failed pattern often
  leads to a strong move in the OPPOSITE direction (trapped traders exit).
</Callout>
