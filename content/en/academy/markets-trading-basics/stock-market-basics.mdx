...
<Callout type="info" title="Key Concept">
  The stock market serves two purposes: companies raise capital by selling shares to the public (IPO), and
  investors/traders buy and sell those shares to profit from price changes or earn dividends.
</Callout>
