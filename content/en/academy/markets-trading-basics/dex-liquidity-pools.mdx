...
description: "Understand DEX liquidity pools and their impact on price. Learn impermanent loss, concentrated liquidity, and how large LP positions create support/resistance."
level: advanced
order: 74
