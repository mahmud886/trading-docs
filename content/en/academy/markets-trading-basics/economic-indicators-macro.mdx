...
<Callout type="warning" title="NFP Trading Caution">
  NFP creates extreme volatility (50-100+ pip moves in seconds). Many traders avoid trading during the first 15-30
  minutes. Spreads widen 3-10× during the release. Consider trading the aftermath rather than the initial spike.
</Callout>
