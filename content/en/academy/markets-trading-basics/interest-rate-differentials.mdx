...
description: "Master interest rate differential analysis for currency trading. Learn how rate expectations drive forex flows, forward curves, and the carry-to-risk ratio framework."
level: advanced
order: 56
