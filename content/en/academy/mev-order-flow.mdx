...
description: "Understand Maximal Extractable Value (MEV) and on-chain order flow. Learn how searchers, builders, and validators extract value and how it affects your trades."
level: expert
order: 75
