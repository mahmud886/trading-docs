...
<Callout type="info" title="Harami = Inside Bar">
  In Western Price Action terminology, a Harami is the same as an Inside Bar. Many traders prefer the Inside Bar
  approach — trading the breakout of the mother candle's range.
</Callout>
