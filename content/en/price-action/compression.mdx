...
<Callout type="info" title="Spring Analogy">
  Think of compression like pressing a spring. The more you compress it, the more energy builds up. When it finally
  releases, the move is proportional to the compression duration. Longer compression = bigger breakout.
</Callout>
