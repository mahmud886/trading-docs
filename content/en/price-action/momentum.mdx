...
<Callout type="info" title="Momentum is King">
  The side with more momentum wins. If buyers are creating large bullish candles and sellers are creating small bearish
  candles, buyers have momentum. ALWAYS trade in the direction of momentum.
</Callout>
