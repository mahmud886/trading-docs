# ICT & SMC Trading Course - Complete Overview
...
- **All files now separate** (English and Bangla in different files)
...
4. **BOS (Break of Structure)** - Identifying trend continuation
5. **CHOCH (Change of Character)** - Spotting trend reversals
6. **Liquidity** - Understanding liquidity pools
7. **Buy Side Liquidity** - BSL identification and trading
8. **Sell Side Liquidity** - SSL identification and trading
...
13. **Inducement** - Fake moves to trap traders
14. **Premium & Discount** - Price array positioning
15. **Dealing Range** - Institutional price ranges
16. **Order Block** - Institutional footprint candles
17. **Breaker Block** - Failed order blocks
...
22. **OTE (Optimal Trade Entry)** - 62-79% Fibonacci retracement
23. **Market Maker Model** - AMD cycle framework
24. **Judas Swing** - False breakout manipulation
25. **Session Liquidity** - Asian, London, NY liquidity pools
26. **Power of Three** - Accumulation, Manipulation, Distribution
27. **Accumulation** - Position building phase
...
32. **Weekly Bias** - Weekly directional framework
33. **Monthly Bias** - Monthly institutional positioning
34. **Multi Timeframe Analysis** - MTF alignment system
35. **Risk Management** - ICT position sizing and stops
36. **Trade Management** - Scaling out and trailing stops
37. **Complete ICT Trading Model** - Full integrated system
...
├── 02-smc-foundation.mdx
├── 03-market-structure.mdx
├── 04-bos.mdx
├── 05-choch.mdx
├── 06-liquidity.mdx
├── 07-buy-side-liquidity.mdx
├── 08-sell-side-liquidity.mdx
├── 09-equal-highs.mdx
├── 10-equal-lows.mdx
├── 11-liquidity-sweep.mdx
├── 12-liquidity-grab.mdx
├── 13-inducement.mdx
├── 14-premium-discount.mdx
├── 15-dealing-range.mdx
├── 16-order-block.mdx
├── 17-breaker-block.mdx
├── 18-mitigation-block.mdx
├── 19-fair-value-gap.mdx
├── 20-ifvg.mdx
├── 21-balanced-price-range.mdx
├── 22-ote.mdx
├── 23-market-maker-model.mdx
├── 24-judas-swing.mdx
├── 25-session-liquidity.mdx
├── 26-power-of-three.mdx
├── 27-accumulation.mdx
├── 28-manipulation.mdx
├── 29-distribution.mdx
├── 30-smt-divergence.mdx
├── 31-daily-bias.mdx
├── 32-weekly-bias.mdx
├── 33-monthly-bias.mdx
├── 34-multi-timeframe-analysis.mdx
├── 35-risk-management.mdx
├── 36-trade-management.mdx
├── 37-complete-ict-model.mdx
└── _meta.json
```
...
4. ✅ **Institutional Logic** - Smart Money perspective
5. ✅ **Trading Application** - Practical trading strategies
6. ✅ **Common Mistakes** - Pitfalls to avoid
7. ✅ **Advanced Notes** - Deep concepts for experienced traders
8. ✅ **Example** - Real market scenario with actual price levels
...
- ✅ With **proper navigation** between topics
...
- **Practical Application** - Step-by-step trading instructions
...
- ✅ Institutional Patterns (Judas, PO3, Market Maker Model)
- ✅ Session Analysis (Asian, London, NY)
- ✅ Bias Framework (Daily, Weekly, Monthly)
...
4. **Complete System (Topics 29-37)** - Master the full framework
...
- ✅ **Top Position** - First item in Academy sidebar
