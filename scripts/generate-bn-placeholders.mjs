...
const expandedCategories = [
  { category: 'academy', files: [
    'central-bank-analysis', 'cot-report', 'institutional-positioning', 'sentiment-analysis',
    'carry-trade', 'seasonal-patterns', 'interest-rate-differentials', 'gdp-inflation-cycles',
    'slippage-management', 'spread-dynamics', 'liquidity-providers', 'ecn-vs-market-maker',
    'smart-order-routing', 'twap-execution', 'vwap-execution', 'partial-fills-scaling',
    'funding-rate-trading', 'liquidation-heatmaps', 'on-chain-analysis',
    'basis-trading', 'dex-liquidity-pools', 'mev-order-flow'
  ]},
  { category: 'smc', files: [
    'supply-demand-zones', 'fresh-vs-tested', 'rally-base-rally',
    'zone-strength-scoring', 'proximal-distal-lines'
  ]},
  { category: 'ict', files: [
    'options-flow-signals', 'max-pain-theory', 'gamma-exposure',
    'put-call-ratio', 'options-expiry-pinning'
  ]}
];
