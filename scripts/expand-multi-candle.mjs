...
const w = (l, cat, s, f, c) => {
  writeFileSync(
    join(C, l, "price-action", cat, s + ".mdx"),
    `---\ntitle: "${f.title}"\ndescription: "${f.description}"\nlevel: ${f.level}\norder: ${f.order}\nlastUpdated: "2026-06-10"\n---\n` +
      c,
    "utf-8",
  );
  console.log(`✅ ${l}/price-action/${cat}/${s}`);
};
...
w(
  ...
  "engulfing",
  {
    ...
    description:
      "Master the Engulfing pattern — the most powerful 2-candle reversal signal. Learn bullish and bearish Engulfing, psychology, and professional trading techniques.",
    level: "beginner",
    order: 1,
  },
  `
...
w(
  ...
  "engulfing",
  {
    ...
    description:
      "Engulfing Pattern আয়ত্ত করুন — সবচেয়ে শক্তিশালী 2-candle Reversal Signal। Bullish ও Bearish Engulfing, Psychology এবং Professional Trading Technique শিখুন।",
    level: "beginner",
    order: 1,
  },
  `
...
w(
  ...
  "morning-star",
  {
    ...
    description:
      "Master the Morning Star 3-candle bullish reversal pattern. Learn identification, psychology, and entry techniques.",
    level: "beginner",
    order: 2,
  },
  `
...
w(
  ...
  "morning-star",
  {
    ...
    description:
      "Morning Star 3-candle Bullish Reversal Pattern আয়ত্ত করুন। চিহ্নিতকরণ, Psychology ও Entry Technique শিখুন।",
    level: "beginner",
    order: 2,
  },
  `
...
w(
  ...
  "harami",
  {
    ...
    description:
      "Master the Harami (Inside Bar) reversal pattern. Learn bullish and bearish Harami identification and trading strategies.",
    level: "beginner",
    order: 4,
  },
  `
...
w(
  ...
  "harami",
  {
    ...
    description:
      "Harami (Inside Bar) Reversal Pattern আয়ত্ত করুন। Bullish ও Bearish Harami চিহ্নিতকরণ ও Trading Strategy শিখুন।",
    level: "beginner",
    order: 4,
  },
  `
...
w(
  ...
  "tweezer-tops-bottoms",
  {
    ...
    description:
      "Master Tweezer patterns — double rejection signals at the same price level indicating strong reversal potential.",
    level: "beginner",
    order: 7,
  },
  `
...
w(
  ...
  "tweezer-tops-bottoms",
  {
    ...
    description:
      "Tweezer Pattern আয়ত্ত করুন — একই Price Level-এ Double Rejection Signal যা শক্তিশালী Reversal Potential নির্দেশ করে।",
    level: "beginner",
    order: 7,
  },
  `
