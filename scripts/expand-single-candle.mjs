...
w(
  ...
  "hammer",
  {
    ...
    description:
      "Master the Hammer pattern. Learn identification rules, psychology, optimal trading locations, entry/exit strategies, and real-world examples.",
    level: "beginner",
    order: 1,
  },
  `
...
w(
  ...
  "hammer",
  {
    ...
    description:
      "Hammer Pattern আয়ত্ত করুন। চিহ্নিতকরণ নিয়ম, Psychology, সেরা Trading Location, Entry/Exit Strategy এবং বাস্তব উদাহরণ শিখুন।",
    level: "beginner",
    order: 1,
  },
  `
...
w(
  ...
  "shooting-star",
  {
    ...
    description:
      "Master the Shooting Star bearish reversal pattern. Learn identification, psychology, and precise trading strategies.",
    level: "beginner",
    order: 2,
  },
  `
...
w(
  ...
  "shooting-star",
  {
    ...
    description:
      "Shooting Star Bearish Reversal Pattern আয়ত্ত করুন। চিহ্নিতকরণ, Psychology এবং সুনির্দিষ্ট Trading Strategy শিখুন।",
    level: "beginner",
    order: 2,
  },
  `
...
w(
  ...
  "doji",
  {
    ...
    description:
      "Master the Doji pattern — the ultimate indecision candle. Learn all Doji types, psychology, and when they signal reversals vs. continuation.",
    level: "beginner",
    order: 3,
  },
  `
...
w(
  ...
  "doji",
  {
    ...
    description:
      "Doji Pattern আয়ত্ত করুন — চূড়ান্ত Indecision Candle। সব Doji Type, Psychology এবং কখন Reversal vs. Continuation Signal দেয় শিখুন।",
    level: "beginner",
    order: 3,
  },
  `
...
w(
  ...
  "pin-bar",
  {
    ...
    description:
      "Master the Pin Bar — the most traded rejection pattern. Learn bullish and bearish Pin Bars, optimal locations, and professional entry techniques.",
    level: "beginner",
    order: 4,
  },
  `
...
w(
  ...
  "pin-bar",
  {
    ...
    description:
      "Pin Bar আয়ত্ত করুন — সবচেয়ে বেশি Trade হওয়া Rejection Pattern। Bullish ও Bearish Pin Bar, সেরা Location এবং Professional Entry Technique শিখুন।",
    level: "beginner",
    order: 4,
  },
  `
...
w(
  ...
  "marubozu",
  {
    ...
    description:
      "Master the Marubozu — the strongest momentum candle. Learn bullish and bearish Marubozu, what they signal, and how to trade continuation.",
    level: "beginner",
    order: 5,
  },
  `
...
w(
  ...
  "marubozu",
  {
    ...
    description:
      "Marubozu আয়ত্ত করুন — সবচেয়ে শক্তিশালী Momentum Candle। Bullish ও Bearish Marubozu, Signal এবং Continuation Trade করা শিখুন।",
    level: "beginner",
    order: 5,
  },
  `
...
w(
  ...
  "hanging-man",
  {
    ...
    description:
      "Master the Hanging Man — a bearish reversal warning at the top of uptrends. Learn identification and trading strategies.",
    level: "beginner",
    order: 6,
  },
  `
...
w(
  ...
  "hanging-man",
  {
    ...
    description:
      "Hanging Man আয়ত্ত করুন — Uptrend-এর শীর্ষে Bearish Reversal সতর্কতা। চিহ্নিতকরণ ও Trading Strategy শিখুন।",
    level: "beginner",
    order: 6,
  },
  `
...
w(
  ...
  "spinning-top",
  {
    ...
    description:
      "Master the Spinning Top indecision pattern. Learn when it signals reversal potential and when it's just noise.",
    level: "beginner",
    order: 8,
  },
  `
...
w(
  ...
  "spinning-top",
  {
    ...
    description:
      "Spinning Top Indecision Pattern আয়ত্ত করুন। কখন Reversal Potential Signal দেয় ও কখন শুধু Noise শিখুন।",
    level: "beginner",
    order: 8,
  },
  `
