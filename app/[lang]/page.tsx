  ...
  return (
    <div className="relative">
      ...
      <section className="relative mx-auto max-w-6xl px-6 pb-24 pt-28 text-center sm:pt-36">
        ...
        <h1 className="text-5xl font-bold tracking-tight text-foreground sm:text-7xl">{dict.hero.title}</h1>
      ...
      <section className="relative mx-auto max-w-6xl px-6 pb-28">
        <div className="mb-12 text-center">
          ...
          <p className="mt-3 text-muted-foreground">
            {lang === "bn"
              ? "ফাউন্ডেশন থেকে এক্সপার্ট লেভেল পর্যন্ত সম্পূর্ণ কারিকুলাম"
              : "Complete curriculum from foundation to expert-level institutional trading"}
          </p>
        </div>
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-5">
          {[
            {
              title: lang === "bn" ? "প্রাইস অ্যাকশন" : "Price Action",
              href: `/${lang}/price-action`,
              color: "#00ff9d",
              icon: TrendingUp,
              desc: lang === "bn" ? "ক্যান্ডেলস্টিক, মার্কেট স্ট্রাকচার" : "Candlesticks, market structure",
            },
            {
              title: lang === "bn" ? "স্মার্ট মানি" : "Smart Money",
              href: `/${lang}/smc`,
              color: "#38bdf8",
              icon: Target,
              desc: lang === "bn" ? "অর্ডার ব্লক, FVG, লিকুইডিটি" : "Order blocks, FVG, liquidity",
            },
            {
              title: lang === "bn" ? "ICT কনসেপ্ট" : "ICT Concepts",
              href: `/${lang}/ict`,
              color: "#fb923c",
              icon: LineChart,
              desc: lang === "bn" ? "কিল জোন, মার্কেট মেকার মডেল" : "Kill zones, market maker models",
            },
            {
              title: lang === "bn" ? "অর্ডার ফ্লো" : "Order Flow",
              href: `/${lang}/order-flow`,
              color: "#ef4444",
              icon: Activity,
              desc: lang === "bn" ? "DOM, ভলিউম প্রোফাইল, VWAP" : "DOM, volume profile, VWAP",
            },
            {
              title: lang === "bn" ? "ওয়াইকফ" : "Wyckoff",
              href: `/${lang}/wyckoff`,
              color: "#f59e0b",
              icon: Workflow,
              desc: lang === "bn" ? "একুমুলেশন, ডিস্ট্রিবিউশন, VSA" : "Accumulation, distribution, VSA",
            },
            {
              title: lang === "bn" ? "ইন্টারমার্কেট" : "Intermarket",
              href: `/${lang}/intermarket`,
              color: "#38bdf8",
              icon: Globe,
              desc: lang === "bn" ? "কোরিলেশন, ইয়েল্ড কার্ভ" : "Correlations, yield curves",
            },
            {
              title: lang === "bn" ? "কোয়ান্টিটেটিভ" : "Quantitative",
              href: `/${lang}/quantitative`,
              color: "#c084fc",
              icon: Brain,
              desc: lang === "bn" ? "এক্সপেক্টেন্সি, মন্টে কার্লো" : "Expectancy, Monte Carlo",
            },
            {
              title: lang === "bn" ? "অকশন মার্কেট" : "Auction Market",
              href: `/${lang}/auction-market`,
              color: "#00ff9d",
              icon: Layers,
              desc: lang === "bn" ? "মার্কেট প্রোফাইল, TPO চার্ট" : "Market profile, TPO charts",
            },
            {
              title: lang === "bn" ? "ফরেক্স সেশন" : "Forex Sessions",
              href: `/${lang}/forex-sessions`,
              color: "#a855f7",
              icon: Clock,
              desc: lang === "bn" ? "কিল জোন, সেশন ওভারল্যাপ" : "Kill zones, session overlaps",
            },
            {
              title: lang === "bn" ? "একাডেমি" : "Academy",
              href: `/${lang}/academy`,
              color: "#10b981",
              icon: GraduationCap,
              desc: lang === "bn" ? "সাইকোলজি, রিস্ক ম্যানেজমেন্ট" : "Psychology, risk management",
            },
          ].map((cat) => {
            const Icon = cat.icon;
            return (
              ...
              >
                <div
                  ...
                  style={{ background: `radial-gradient(300px at 50% 0%, ${cat.color}08, transparent 70%)` }}
                />
                <div
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-28">
          ...
          <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              >
                <div className="mb-4 text-5xl font-bold opacity-20" style={{ color: path.color }}>
                  {path.level}
                </div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-28">
        <div className="mb-12 text-center">
          <h2 className="text-3xl font-bold text-foreground sm:text-4xl">
            {lang === "bn" ? "প্রো ট্রেডিং টুলস" : "Professional Trading Tools"}
          </h2>
          <p className="mt-4 text-muted-foreground">
            {lang === "bn"
              ? "ইনস্টিটিউশনাল ডেস্ক-লেভেল ক্যালকুলেটর — সম্পূর্ণ বিনামূল্যে"
              : "Institutional desk-level calculators and analysis tools — completely free"}
          </p>
        </div>
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {[
            {
              icon: Shield,
              title: lang === "bn" ? "রিস্ক ম্যানেজমেন্ট সুইট" : "Risk Management Suite",
              desc:
                lang === "bn"
                  ? "পজিশন সাইজার, ড্রডাউন ক্যালকুলেটর, মার্জিন ট্র্যাকার"
                  : "Position sizer, drawdown calculator, margin tracker, expectancy calculator",
              href: `/${lang}/tools`,
              color: "#00ff9d",
            },
            {
              icon: BarChart3,
              title: lang === "bn" ? "লাইভ চার্ট ও COT ডেটা" : "Live Charts & COT Data",
              desc:
                lang === "bn"
                  ? "TradingView চার্ট, COT পজিশনিং, কারেন্সি স্ট্রেংথ"
                  : "TradingView charts, COT positioning data, currency strength meter",
              href: `/${lang}/charts`,
              color: "#38bdf8",
            },
            {
              icon: Brain,
              title: lang === "bn" ? "কোয়ান্ট টুলস" : "Quant Tools",
              desc:
                lang === "bn"
                  ? "ইকুইটি কার্ভ সিমুলেটর, রিজিম ডিটেক্টর, কম্পাউন্ডিং"
                  : "Equity curve simulator, Monte Carlo, regime detector, compounding",
              href: `/${lang}/tools/equity-simulator`,
              color: "#c084fc",
            },
          ].map((feature) => {
      ...
      <section className="relative border-t border-border/30">
        <div className="mx-auto max-w-6xl px-6 py-28">
          <div className="text-center">
            ...
            <h2 className="text-3xl font-bold text-foreground sm:text-4xl">
              {lang === "bn" ? "ব্যাংকদের মতো ট্রেড করুন" : "Trade Like the Banks"}
            </h2>
          ...
          <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              {
                title: lang === "bn" ? "অর্ডার ফ্লো অ্যানালাইসিস" : "Order Flow Analysis",
                desc:
                  lang === "bn"
                    ? "DOM, ফুটপ্রিন্ট চার্ট, ডেল্টা — ইনস্টিটিউশনাল ফুটপ্রিন্ট দেখুন"
                    : "DOM, footprint charts, delta — see institutional footprints invisible on regular charts",
                color: "#00ff9d",
              },
              {
                title: lang === "bn" ? "লিকুইডিটি ইঞ্জিনিয়ারিং" : "Liquidity Engineering",
                desc:
                  lang === "bn"
                    ? "ইনস্টিটিউশনরা কিভাবে স্টপ হান্ট করে এবং ফাঁদে ফেলে"
                    : "How institutions hunt stops and trap retail traders before the real move",
                color: "#38bdf8",
              },
              {
                title: lang === "bn" ? "টাইম-বেসড ট্রেডিং" : "Time-Based Trading",
                desc:
                  lang === "bn"
                    ? "কিল জোন, লন্ডন ফিক্স, NY ওপেন — কখন ব্যাংকরা অ্যাক্টিভ"
                    : "Kill zones, London Fix, NY Open — when banks are most active in the markets",
                color: "#fb923c",
              },
            ].map((item) => (
      ...
      <section className="relative border-t border-border/30">
        <div className="mx-auto max-w-4xl px-6 py-28 text-center">
          <h2 className="text-3xl font-bold text-foreground sm:text-4xl">
            {lang === "bn" ? "আজই শুরু করুন" : "Start Your Journey Today"}
          </h2>
          <p className="mx-auto mt-4 max-w-xl text-lg text-muted-foreground">
            {lang === "bn"
              ? "সম্পূর্ণ বিনামূল্যে। কোনো সাইনআপ প্রয়োজন নেই। ট্রেডারদের জন্য তৈরি।"
              : "Completely free. No signup required. Built by traders, for traders who refuse to stay retail."}
          </p>
