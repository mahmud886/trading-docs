...
export default function RiskRewardCalculator() {
  ...
  const [stopLossPrice, setStopLossPrice] = useState<number>(1.085);
  const [takeProfitPrice, setTakeProfitPrice] = useState<number>(1.1);
      ...
      <div className="bg-card border border-border rounded-2xl backdrop-blur-xl p-8">
        ...
        <div className="mt-8 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-foreground mb-2">Take Profit Price</label>
              <input
                type="number"
        ...
        <div className="mt-8 bg-muted border border-border rounded-xl p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-muted p-4 rounded-lg border border-red-500/20">
              ...
              <p className="text-2xl font-bold text-red-400 mt-1">{metrics.riskPips.toFixed(4)}</p>
            </div>
            ...
            <div className="bg-muted p-4 rounded-lg border border-green-500/20">
              ...
              <p className="text-2xl font-bold text-green-400 mt-1">{metrics.profitPips.toFixed(4)}</p>
            </div>
            ...
            <div className="bg-muted p-4 rounded-lg border border-blue-500/20 col-span-2">
              ...
              <p className="text-3xl font-bold text-blue-400 mt-1">1 : {metrics.riskRewardRatio.toFixed(2)}</p>
            ...
            <div className="bg-muted p-4 rounded-lg border border-red-500/20">
              ...
              <p className="text-xl font-bold text-red-400 mt-1">${metrics.riskAmount.toFixed(2)}</p>
            </div>

            <div className="bg-muted p-4 rounded-lg border border-green-500/20">
              <p className="text-muted-foreground text-sm">Profit Amount</p>
              <p className="text-xl font-bold text-green-400 mt-1">${metrics.profitAmount.toFixed(2)}</p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-3">
            <div>
              <div className="flex items-baseline justify-between mb-2">
                ...
                <p className="text-2xl font-bold text-purple-400">{metrics.winRateRequired.toFixed(1)}%</p>
              </div>
              ...
              <p className="text-xs text-muted-foreground mt-2">
                You need to win at least {metrics.winRateRequired.toFixed(1)}% of your trades to break even with this
                risk-reward ratio
              </p>
            </div>
