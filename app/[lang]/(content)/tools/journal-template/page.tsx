    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-card border border-border rounded-2xl backdrop-blur-xl p-8">
        ...
        <p className="text-muted-foreground">
          Track your trades and analyze your trading performance over time
        </p>
        ...
        <div className="mt-8 grid grid-cols-4 gap-4">
          ...
          <div className={`rounded-lg p-4 text-center border ${totalProfitLoss >= 0 ? "bg-green-900/20 border-green-500/30" : "bg-red-900/20 border-red-500/30"}`}>
            <p className={`text-xs uppercase tracking-wide ${totalProfitLoss >= 0 ? "text-green-400" : "text-red-400"}`}>
              Total P&L
            </p>
        ...
        <div className="mt-8">
          ...
          {showAddForm && (
            <div className="bg-muted border border-border rounded-lg p-4 mb-4">
              <p className="text-muted-foreground text-sm">Entry form coming soon - Track your trades manually for now</p>
            </div>
          )}
              ...
              <tbody>
                {entries.map((entry, idx) => (
                  <tr key={idx} className="border-b border-border hover:bg-muted/20 transition-colors">
                    ...
                    <td className={`py-3 px-4 text-right font-semibold ${entry.profitLoss >= 0 ? "text-green-400" : "text-red-400"}`}>
        ...
        <div className="mt-8 bg-amber-500/10 border border-amber-500/20 rounded-xl p-6">
          ...
          <div className="space-y-2 text-sm text-foreground">
            <p>✓ <span className="font-semibold">Record EVERY trade</span> - Even small ones count for your analysis</p>
            <p>✓ <span className="font-semibold">Document your setup</span> - What confluence factors did you see?</p>
            <p>✓ <span className="font-semibold">Note your emotions</span> - How did you feel entering/exiting?</p>
            <p>✓ <span className="font-semibold">Review weekly</span> - Look for patterns in your winners and losers</p>
            <p>✓ <span className="font-semibold">Track P&L monthly</span> - Monitor your profitability trends</p>
            <p>✓ <span className="font-semibold">Analyze your W/L ratio</span> - Are you following your rules?</p>
          </div>
        </div>
        ...
        <div className="mt-8 bg-muted border border-border rounded-xl p-6">
          ...
          <div className="space-y-3">
            <div className="p-4 bg-muted rounded-lg border border-border">
              ...
              <p className="text-muted-foreground text-sm mt-1">Professional journal template with formulas for P&L tracking</p>
              <button
                onClick={downloadCSV}
